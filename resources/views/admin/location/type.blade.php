        ...
        <div class="container-fluid">
            <div class="navbar-collapse collapse in">
                ...
                <ul class="nav navbar-nav navbar-left">
                    <li class="navbar-title"><strong>All Establishment Types</strong></li>
            ...
            return {
                ...
                deleteType: function() {
                    $(document).on('click', '.btnDeleteType', function (e) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "{{ route('ajax.administrator.location.delete.type') }}",
                ...
                editType: function () {
                    ...
                    $(document).on('click', '.btnEditType', function (e) {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: "{{ route('ajax.administrator.location.edit.type') }}",
                            data: {'id': $dataRequestId},
                            dataType: 'json',
                            beforeSend: function () {
                ...
                loadTypes: function () {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: "{{ route('ajax.administrator.location.types') }}",
                        dataType: 'html',
                        beforeSend: function () {
                ...
                addEditType: function () {
                    ...
                    $('#btnAddType').on('click', function (e) {
                        ...
                        if ($('#btnAddType').text() == 'Add New') {
                            $.ajax({
                                type: 'POST',
                                url: "{{ route('ajax.administrator.location.add.type') }}",
                            ...
                            $.ajax({
                                type: 'POST',
                                url: "{{ route('ajax.administrator.location.update.type') }}",
