        ...
        <div class="col-sm-8 col-xs-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <!-- Profile Form -->
                        <form class="form form-horizontal" action="{{ route('admin.user.profile.update', [$user->id]) }}" method="post">
                            {{ csrf_field() }}
                            <input type="hidden" name="id" value="{{ $user->id }}">
                            <div class="section">
                                    ...
                                    <div class="form-group {{ $errors->has('gender') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-9">
                                            <div class="radio radio-inline">
                                                <input type="radio" name=gender id="radio10" value="male" @if($user->profile->gender == 'male') checked @endif>
                                                <label for="radio10">
                                                    Male
                                                </label>
                                            </div>
                                            <div class="radio radio-inline">
                                                <input type="radio" name="gender" id="radio11" value="female" @if($user->profile->gender == 'female') checked @endif>
                                                <label for="radio11">
                                                    Female
                                                </label>
                                            </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-9 col-md-offset-3">
                                        ...
                                        <div class="pull-right">
                                            <a href="{{ route('admin.user.add') }}" class="btn btn-success">Add New User</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
